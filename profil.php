...
if (isset($_POST['password_lama'])) {
    ...
    if ($data == 0) {
        echo '<script>alert("Password Lama Salah !");location.href="?page=profil";</script>';
    } elseif ($_POST['password_baru'] != $_POST['konfirmasi_password_baru']) {
        echo '<script>alert("Konfirmasi Password Baru Salah !");location.href="?page=profil";</script>';
    } else {
        $query = mysqli_query($koneksi, "UPDATE user SET password='$password_baru' WHERE username='$username'");
        if ($query) {
            echo '<script>alert("Password Berhasil Diubah !");location.href="?page=profil";</script>';
        }
    }
}
?>
    ...
    <div class="col-md-4 col-xl-3">
        <div class="card mb-3">
            ...
            <div class="card-body text-center">
                <img src="foto/<?php echo $_SESSION['user']['foto'] ?>" alt="Rafa Kalvin Allan" class="img-fluid rounded-circle mb-2" width="128" height="128" />
