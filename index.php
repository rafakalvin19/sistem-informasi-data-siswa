				...
				<ul class="sidebar-nav">
					...
					?>">
						<a class="sidebar-link" href="index.php">
							<i class="align-middle" data-feat	her="sliders"></i> <span class="align-middle">Dashboard</span>
						</a>
					</li>
					...
					<ul class="navbar-nav navbar-align">
						<li class="nav-item dropdown">
							...
							<a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
								<img src="foto/<?php echo $_SESSION['user']['foto'] ?>" class="avatar img-fluid rounded me-1" alt="<?php echo $_SESSION['user']['nama'] ?>" /> <span class="text-dark"><?php echo $_SESSION['user']['nama'] ?></span>
							</a>
						...
						<div class="container-fluid">
							<div class="row text-muted">
								<div class="col-6 text-start">
									<p class="mb-0">
										<a class="text-muted" href="https://www.instagram.com/rafakalvn_/" target="_blank"><strong>Admin Slot</strong></a> - <a class="text-muted" href="https://www.instagram.com/rafakalvn_/" target="_blank"><strong>Rafa Ganteng
												Bangetzz</strong></a> &copy;
									</p>
								</div>
							</div>
						</div>
